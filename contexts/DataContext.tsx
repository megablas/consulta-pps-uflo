      ...
      try {
          ...
          const [practicasResult, solicitudesResult, lanzamientosResult, enrollmentsResult] = await Promise.all([
              ...
              fetchAirtableData<LanzamientoPPSFields>(
                  ...
                  [FIELD_NOMBRE_PPS_LANZAMIENTOS, FIELD_ORIENTACION_LANZAMIENTOS, FIELD_DIRECCION_LANZAMIENTOS, FIELD_HORARIO_SELECCIONADO_LANZAMIENTOS, FIELD_FECHA_INICIO_LANZAMIENTOS, FIELD_FECHA_FIN_LANZAMIENTOS, FIELD_HORAS_ACREDITADAS_LANZAMIENTOS], 
