      ...
      try {
          ...
          const [practicasResult, solicitudesResult, lanzamientosResult, enrollmentsResult] = await Promise.all([
              ...
              fetchAirtableData<ConvocatoriaFields>(
                  ...
                  [FIELD_LANZAMIENTO_VINCULADO_CONVOCATORIAS, FIELD_ESTADO_INSCRIPCION_CONVOCATORIAS, FIELD_INFORME_SUBIDO_CONVOCATORIAS], 
          ...
          const selectedEnrollments = enrollmentsData.filter(e => e[FIELD_ESTADO_INSCRIPCION_CONVOCATORIAS] === 'Seleccionado');
