import {
    ...
    AIRTABLE_TABLE_NAME_ASISTENCIAS_JORNADA,
...
export const schema = {
    ...
    asistenciasJornada: {
        _tableName: AIRTABLE_TABLE_NAME_ASISTENCIAS_JORNADA,
        estudianteLink: FIELD_ASISTENCIA_ESTUDIANTE,
        moduloId: FIELD_ASISTENCIA_MODULO_ID,
        moduloAsistido: FIELD_ASISTENCIA_MODULO_NOMBRE,
        fecha: FIELD_ASISTENCIA_FECHA,
