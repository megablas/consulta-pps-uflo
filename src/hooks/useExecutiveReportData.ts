...
const useExecutiveReportData = ({ reportType, enabled = false }: { reportType: ReportType | null; enabled?: boolean }) => {
            ...
            const generateSingleYearReport = (year: number): ExecutiveReportData => {
                ...
                return {
                    ...
                    kpis: {
                        ...
                        studentsWithoutPpsExcludingRelevamiento: { current: currentSnapshot.studentsWithoutPpsExcludingRelevamiento, previous: previousSnapshot.studentsWithoutPpsExcludingRelevamiento },
