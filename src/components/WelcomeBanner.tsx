...
const InfoItem: React.FC<{
  ...
  return (
    <div className="flex items-center gap-3 bg-white/60 p-3 rounded-xl border border-slate-200/80 shadow-sm hover:shadow-lg hover:bg-white hover:border-blue-300/70 transition-all duration-300 transform hover:-translate-y-0.5">
      <span className="material-icons text-blue-500 !text-2xl">{icon}</span>
...
const WelcomeBannerSkeleton: React.FC = () => (
  <div className="p-6 sm:p-8 rounded-2xl bg-slate-100 animate-pulse">
...
const WelcomeBanner: React.FC<WelcomeBannerProps> = ({
  ...
  return (
    <div className="relative p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-lg overflow-hidden bg-gradient-to-br from-blue-50/80 via-white/70 to-slate-50/80 backdrop-blur-lg">
      {/* Fondo decorativo */}
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-blue-400/10 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-24 -left-20 w-72 h-72 bg-indigo-400/10 rounded-full blur-3xl"></div>
