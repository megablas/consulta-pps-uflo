        ...
        <Card className="mt-8" icon="edit_note" title="Anotaciones Internas" description="Estas notas son privadas y solo visibles para administradores y jefes de cátedra.">
           <div className="mt-6 border-t border-slate-200 pt-6">
                <textarea
                    ...
                    rows={5}
                    className="w-full text-sm rounded-lg border border-slate-300 p-3 bg-slate-50/50 shadow-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
                ...
                <div className="mt-4 flex justify-end">
                    <button
                        ...
                        className="bg-slate-800 text-white font-bold py-2.5 px-6 rounded-lg text-sm transition-all duration-200 shadow-md hover:bg-slate-700 hover:-translate-y-px flex items-center gap-2 justify-center disabled:bg-slate-400 disabled:cursor-not-allowed disabled:shadow-none disabled:translate-y-0"
                    >
