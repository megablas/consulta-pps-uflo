    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex items-center justify-center min-h-[60vh] animate-fade-in-up">
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-red-200/60 max-w-lg">
            <div className="mx-auto bg-red-100 text-red-600 rounded-full h-16 w-16 flex items-center justify-center">
              <span className="material-icons !text-4xl">report_problem</span>
            </div>
            <h1 className="mt-6 text-2xl font-bold text-slate-800">Oops, algo salió mal.</h1>
